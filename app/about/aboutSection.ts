...
export const aboutSection: AboutSection[] = [
  {
    ...
    delay: 0.25,
    classNames:
      "text-4xl uppercase text-browny max-sm:text-2xl " +
  ...
  },
  {
    ...
    delay: 0.5,
    classNames:
      "text-4xl w-[300px] leading-[40px] uppercase text-custom-white max-sm:text-2xl max-sm:w-[200px] " +
      GildaDisplay.className,
  },
  {
    text: "Developer",
    delay: 0.75,
    classNames: "text-3xl  text-custom-white mt-2 max-sm:text-xl  ",
  },
  {
    ...
    delay: 1,
    classNames: "text-base font-lighter mt-10 max-sm:text-sm max-sm:mt-4",
  },
  {
    ...
    delay: 1.25,
    classNames:
      "text-base font-lighter text-browny mt-10 max-sm:text-sm max-sm:mt-4",
  },
  {
    text: "(+212)762868577",
    delay: 1.5,
    classNames:
      "text-2xl font-lighter text-browny mt-10 max-sm:text-[18px] max-sm:mt-4",
  },
  {
    text: "https://bayoussefismail.com",
    delay: 1.75,
    classNames: "text-2xl font-lighter text-browny max-sm:text-[18px]",
  },
  {
